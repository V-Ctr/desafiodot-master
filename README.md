...
package "Security" {
    [OAuth2, OpenID Connect, TLS/SSL]
}

[Web/Mobile] --> [NGINX/HAProxy] : request
[NGINX/HAProxy] --> [Web/Mobile] : response

[NGINX/HAProxy] --> [Kong/Zuul] : request
[Kong/Zuul] --> [NGINX/HAProxy] : response

[Kong/Zuul] --> [Istio/Linkerd] : request
[Istio/Linkerd] --> [Kong/Zuul] : response

[Istio/Linkerd] --> [Docker Containers] : request
[Docker Containers] --> [Istio/Linkerd] : response

[Docker Containers] --> [Kubernetes] : request
[Kubernetes] --> [Docker Containers] : response

[Kubernetes] --> [Jenkins/GitLab CI] : request
[Jenkins/GitLab CI] --> [Kubernetes] : response

[Jenkins/GitLab CI] --> [Prometheus, Grafana, ELK] : request
[Prometheus, Grafana, ELK] --> [Jenkins/GitLab CI] : response

[Prometheus, Grafana, ELK] --> [OAuth2, OpenID Connect, TLS/SSL] : request
[OAuth2, OpenID Connect, TLS/SSL] --> [Prometheus, Grafana, ELK] : response
@enduml